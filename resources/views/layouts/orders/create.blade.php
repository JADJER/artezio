                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="list-group">
                            <div class="list-group-item active"><span class="badge">0/50</span>Обьекты собственности</div>
            ...
            <div class="row">
                <div class="col-md-offset-8 col-md-2">
                    <div class="form-group">
                        <button id="singlebutton" form="form_order" name="singlebutton" class="btn btn-primary">Добавить обьект собственности</button>
                    </div>
                </div>
            </div>
        </div>
